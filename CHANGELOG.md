...
- **A closing fill with no usable broker timestamp (missing or in the future) can add to today's daily loss but never reduce it**, so an untimestamped winning close cannot re-open entries after the daily-loss limit has been hit.
