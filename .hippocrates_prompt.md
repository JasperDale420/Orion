...
SEVERITY: critical
FINGERPRINT: c6e2cc8307db43b9

ERROR TRACE:


MESSAGE:
CIRCUIT BREAKER OPENED: CRITICAL: Heartbeat missing for 67.19s > 60.0s
...
- [repo:Orion] [service:app] [fingerprint:51631fb90e817f7f] ERROR FIX RECORD | Orion / app Fingerprint: 51631fb90e817f7f Severity: critical Stack root: Message: CIRCUIT BREAKER OPENED: CRITICAL: Heartbeat missing for 191.75s > 60.0s Context: Outcome: no_changes Branch: hipp/orion-51631fb9-202604091617 PR URL: - Changed files: .hippocrates_prompt.md Worker stdout: max-size: "10m" | max-file: "3" | volumes: | timescaledb_data: Worker stderr: -
