...
SEVERITY: critical
FINGERPRINT: fd91687272b756ae

ERROR TRACE:


MESSAGE:
HEALTH MONITOR FAILURE: CRITICAL: Heartbeat missing for 67.19s > 60.0s
...
- [repo:Orion] [service:app] [fingerprint:efb3e03fcb557923] ERROR FIX RECORD | Orion / app Fingerprint: efb3e03fcb557923 Severity: critical Stack root: Message: HEALTH MONITOR FAILURE: CRITICAL: Heartbeat missing for 191.75s > 60.0s Context: Outcome: no_changes Branch: hipp/orion-efb3e03f-202604091617 PR URL: - Changed files: .hippocrates_prompt.md Worker stdout: def _active_event_source_profile(self) -> dict[str, str | bool | list[str]]: | return { | "data_source": "gateway_stream+heber_flow", |
