...
SEVERITY: error
FINGERPRINT: 89974a0563f6bde0

ERROR TRACE:


MESSAGE:
Failed to load registry: Expecting value: line 1 column 1 (char 0)
...
- [repo:Orion] [service:app] [fingerprint:3bdb6b00bc26bf0c] ERROR FIX RECORD | Orion / app Fingerprint: 3bdb6b00bc26bf0c Severity: error Stack root: Message: Test Pipeline Error: pipeline failure Context: Outcome: no_changes Branch: hipp/orion-3bdb6b00-202604141657 PR URL: - Changed files: .hippocrates_prompt.md Worker stdout: - **Decision:** `NON_ACTIONABLE` | - **Root cause:** This is a **false positive from a passing test**. The error message `"Test Pipeline Error: pipeline failure"` is the exp
- [repo:Data-Gateway] [service:api] [fingerprint:7aae149792aea147] ERROR FIX RECORD | Data-Gateway / api Fingerprint: 7aae149792aea147 Severity: error Stack root: Message: alpaca_bars_error Context: Outcome: no_changes Branch: hipp/data-gateway-7aae1497-202603300037 PR URL: - Changed files: .hippocrates_prompt.md Worker stdout: # Gateway uses "1Min", Alpaca uses "1Min" - already compatible | return timeframe | [Output exceeded 2000 line limit (2153 lines total). Full output saved to /var/folders/0
