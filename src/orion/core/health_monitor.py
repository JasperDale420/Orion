...
class HealthMonitor:
    ...
    def __init__(self) -> None:
        ...
        # Thresholds (PRD 9.1)
        # Use configurable max age to provide headroom over the 60s ingestion
        # loop interval; a hardcoded 60s threshold races with the loop and
        # causes spurious circuit-breaker trips.
