...
class NewsDataStream(DataStream):
    ...
    def __init__(
        ...
        """
        super().__init__(
            endpoint=(url_override if url_override is not None else BaseURL.MARKET_DATA_STREAM.value + "/v1beta1/news"),
            api_key=api_key,
    ...
    def subscribe_news(self, handler: Callable[[Union[News, Dict]], Awaitable[None]], *symbols: str) -> None:
        """Subscribe to news
