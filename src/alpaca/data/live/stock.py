...
class StockDataStream(DataStream):
    ...
    def __init__(
        ...
        super().__init__(
            endpoint=(
                url_override if url_override is not None else BaseURL.MARKET_DATA_STREAM.value + "/v2/" + feed.value
            ),
            api_key=api_key,
    ...
    def subscribe_trades(self, handler: Callable[[Union[Trade, Dict]], Awaitable[None]], *symbols: str) -> None:
        """Subscribe to trades.
    ...
    def subscribe_quotes(self, handler: Callable[[Union[Quote, Dict]], Awaitable[None]], *symbols: str) -> None:
        """Subscribe to quotes
    ...
    def subscribe_bars(self, handler: Callable[[Union[Bar, Dict]], Awaitable[None]], *symbols: str) -> None:
    ...
    def subscribe_updated_bars(self, handler: Callable[[Union[Bar, Dict]], Awaitable[None]], *symbols: str) -> None:
    ...
    def subscribe_daily_bars(self, handler: Callable[[Union[Bar, Dict]], Awaitable[None]], *symbols: str) -> None:
    ...
    def register_trade_corrections(self, handler: Callable[[Union[TradeCorrection, Dict]], Awaitable[None]]) -> None:
    ...
    def register_trade_cancels(self, handler: Callable[[Union[TradeCancel, Dict]], Awaitable[None]]) -> None:
