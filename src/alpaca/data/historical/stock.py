...
class StockHistoricalDataClient(RESTClient):
    ...
    def get_stock_latest_trade(self, request_params: StockLatestTradeRequest) -> Union[Dict[str, Trade], RawData]:
    ...
    def get_stock_latest_quote(self, request_params: StockLatestQuoteRequest) -> Union[Dict[str, Quote], RawData]:
    ...
    def get_stock_latest_bar(self, request_params: StockLatestBarRequest) -> Union[Dict[str, Bar], RawData]:
    ...
    def get_stock_snapshot(self, request_params: StockSnapshotRequest) -> Union[Dict[str, Snapshot], RawData]:
