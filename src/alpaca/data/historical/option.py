...
class OptionHistoricalDataClient(RESTClient):
    ...
    def __init__(
        ...
        base_url = url_override if url_override is not None else BaseURL.DATA_SANDBOX if sandbox else BaseURL.DATA
    ...
    def get_option_latest_quote(self, request_params: OptionLatestQuoteRequest) -> Union[Dict[str, Quote], RawData]:
    ...
    def get_option_latest_trade(self, request_params: OptionLatestTradeRequest) -> Union[Dict[str, Trade], RawData]:
    ...
    def get_option_snapshot(self, request_params: OptionSnapshotRequest) -> Union[Dict[str, OptionsSnapshot], RawData]:
    ...
    def get_option_chain(self, request_params: OptionChainRequest) -> Union[Dict[str, OptionsSnapshot], RawData]:
