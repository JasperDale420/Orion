    ...
    def __init__(self, raw_data: RawData) -> None:
        ...
        for corporate_action_type, corporate_actions in raw_data.items():
            if corporate_action_type == "forward_splits":
                ...
                parsed_corporate_actions[corporate_action_type] = [
                    StockAndCashMerger(corporate_action_type=corporate_action_type, **corporate_action)
                    for corporate_action in corporate_actions
                ]
                ...
                parsed_corporate_actions[corporate_action_type] = [
                    WorthlessRemoval(corporate_action_type=corporate_action_type, **corporate_action)
                    for corporate_action in corporate_actions
                ]
            elif corporate_action_type == "rights_distributions":
                parsed_corporate_actions[corporate_action_type] = [
                    RightsDistribution(corporate_action_type=corporate_action_type, **corporate_action)
                    for corporate_action in corporate_actions
                ]
