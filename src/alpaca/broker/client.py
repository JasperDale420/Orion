    ...
    **Note on the `handle_pagination` param you'll see across these methods**
    ...
    def get_account_activities(
        ...
        iterator = self._get_account_activities_iterator(
            ...
            mapping=lambda raw_activities: [self._parse_activity(activity) for activity in raw_activities],
        )
    ...
    def _get_account_activities_iterator(
        ...
        while True:
            ...
            if "id" not in last_result:
                raise APIError("AccountActivity didn't contain an `id` field to use for paginating results")
    ...
    def _parse_activity(data: dict) -> Union[TradeActivity, NonTradeActivity]:
        ...
        if "activity_type" not in data or data["activity_type"] is None:
            raise ValueError("Failed parsing raw activity data, `activity_type` is not present in fields")
    ...
    def create_ach_relationship_for_account(
        ...
        response = self.post(f"/accounts/{account_id}/ach_relationships", ach_data.to_request_fields())
    ...
    def create_bank_for_account(
        ...
        """
        account_id = validate_uuid_id_param(account_id)
        response = self.post(f"/accounts/{account_id}/recipient_banks", bank_data.to_request_fields())
    ...
    def get_journals(self, journal_filter: Optional[GetJournalsRequest] = None) -> Union[List[Journal], RawData]:
        """
    ...
    def get_all_assets(self, filter: Optional[GetAssetsRequest] = None) -> Union[List[Asset], RawData]:
        """
    ...
    def submit_order_for_account(self, account_id: Union[UUID, str], order_data: OrderRequest) -> Union[Order, RawData]:
    ...
    def get_order_for_account_by_client_id(self, account_id: Union[UUID, str], client_id: str) -> Union[Order, RawData]:
        """
    ...
    def cancel_orders_for_account(self, account_id: Union[UUID, str]) -> Union[List[CancelOrderResponse], RawData]:
        """
        Cancels all orders.
    ...
    def cancel_order_for_account_by_id(self, account_id: Union[UUID, str], order_id: Union[UUID, str]) -> None:
        """
    ...
    def get_corporate_announcement_by_id(
        ...
        """
        corporate_announcment_id = validate_uuid_id_param(corporate_announcment_id, "corporate_announcment_id")
    ...
    def get_non_trading_activity_events(self, filter: Optional[GetEventsRequest] = None) -> Iterator:
        """
    ...
    def create_portfolio(self, portfolio_request: CreatePortfolioRequest) -> Union[Portfolio, RawData]:
        """
    ...
    def create_subscription(self, subscription_request: CreateSubscriptionRequest) -> Union[Subscription, RawData]:
        """
        ...
        response = self.post("/rebalancing/subscriptions", data=subscription_request.to_request_fields())
    ...
    def get_subscription_by_id(self, subscription_id: Union[UUID, str]) -> Union[Subscription, RawData]:
        """
    ...
    def create_manual_run(self, rebalancing_run_request: CreateRunRequest) -> Union[RebalancingRun, RawData]:
        """
